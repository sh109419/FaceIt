...
class FaceView: UIView {
    ...
    @IBInspectable
    var mouthCurvature: Double = 0.5 { didSet { setNeedsDisplay() } }// 1 full smile, -1 full frown
    @IBInspectable
    ...
    fileprivate func pathForCircleCenterdAtPoint(_ midPoint: CGPoint, withRadius: CGFloat) -> UIBezierPath {
    ...
    /*override func layoutSubviews() {
        ...
        // eyeview can not response to UIPinchGestureRecognizer
        // move positionEye to draw()
